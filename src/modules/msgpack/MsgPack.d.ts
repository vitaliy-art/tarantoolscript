...
declare module 'msgpack' {
   ...
   */
  export function decode(msgpackString: string, startPosition?: number): LuaMultiReturn<[unknown, number]>;
   ...
   */
  export function decode(pointer: CData, size: number): LuaMultiReturn<[unknown, CData]>;

  /** Input and output are the same as for `decode(string)`. */
  export function decode_unchecked(msgpackString: string, startPosition?: number): LuaMultiReturn<[unknown, number]>;
   ...
   */
  export function decode_unchecked(pointer: CData): LuaMultiReturn<[unknown, CData]>;
   ...
   */
  export function decode_array_header(byteArray: CData, size: number): LuaMultiReturn<[number, CData]>;
   ...
   */
  export function decode_map_header(byteArray: CData, size: number): LuaMultiReturn<[number, CData]>;
   ...
   */
  export const cfg: MsgPackCallable;
   ...
   */
  export function object(value: unknown): MsgPackObject;
   ...
   */
  export function object_from_raw(msgpackString: string): MsgPackObject;
   ...
   * @returns A MsgPack object (Type - `userdata`).
   */
  export function object_from_raw(pointer: CData, size: number): MsgPackObject;
